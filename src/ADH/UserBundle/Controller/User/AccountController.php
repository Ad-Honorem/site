...
/**
 * @Security("has_role('ROLE_USER') and is_fully_authenticated() and not is_granted('ROLE_PREVIOUS_ADMIN')")
 * 
 * @Route("/user/account")
 */
class AccountController extends Controller {
	 ...
	 *
	 * @Route("/", name="adh_user_user_account")
	 * @Method({"GET"})
	 *
	...
	public function defaultAction(Request $request) {
		return ($this->render("ADHUserBundle:User/Account:default.html.twig"));
	}

	/**
	 * Edit password
	 *
	 * @Route("/password", name="adh_user_user_account_password")
	 * @Method({"GET", "POST"})
	 *
	 * @param Request $request 
	...
	public function passwordAction(Request $request) {
		...
		return ($this->render("ADHUserBundle:User/Account:password.html.twig", array(
	...
	public function emailAction(Request $request) {
		...
		return ($this->render("ADHUserBundle:User/Account:email.html.twig", array(
				"form" => $form->createView()
		)));
	}
